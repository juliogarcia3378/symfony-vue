...
class EventApi
{
     ...
     *
     * @param \DateTime $date Date for event. (required)
     * @param string $venue Id for the venue. (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Event[]
     */
    public function eventsGet($date, $venue = null)
    {
        list($response) = $this->eventsGetWithHttpInfo($date, $venue);
        return $response;
    }
     ...
     */
    public function eventsGetWithHttpInfo($date, $venue = null)
    {
        // verify the required parameter 'date' is set
        if ($date === null) {
            throw new \InvalidArgumentException('Missing the required parameter $date when calling eventsGet');
        }
        // parse inputs
        $resourcePath = "/events";
        $httpBody = '';
        ...
        // query params
        if ($venue !== null) {
            $queryParams['venue'] = $this->apiClient->getSerializer()->toQueryValue($venue);
        }
